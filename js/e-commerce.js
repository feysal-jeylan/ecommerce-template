...
async function loadFallbackProducts() {
    ...
    try {
        ...
        console.warn('⚠️ Could not import products.js, using inline fallback:', error);
        // Keep existing inline fallback as last resort (don't delete it,
        // just wrap it in this catch block)
        ...
        console.log(`✅ Loaded ${fallbackProducts.length} inline fallback products`);
    }
}
        ...
        mobileMenuBtn.addEventListener('click', () => {
            ...
            mobileNav.innerHTML = `
                ...
                <div style="display: flex; flex-direction: column; gap: 16px;">
                    <a href="index.html" style="font-size: 1.2rem; font-weight: 600; color: var(--accent); text-decoration: none;">Home</a>
